...
var AdminSidebarComponent = (function () {
    function AdminSidebarComponent(projectService, utilityService, notificationService, location, route, router) {
    ...
    AdminSidebarComponent.prototype.getProject = function () {
        var _this = this;
    ...
    AdminSidebarComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './app/modules/admin/components/adminSidebar.component.html'
        }), 
